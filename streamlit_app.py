...
2. พฤติกรรมสุขภาพ: ระยะเวลาการนอน (Sleep Duration), ระดับกิจกรรมทางกาย (Physical Activity Level), ระดับความเครียด (Stress Level) , ความผิดปกติของการนอน (Sleep Disorder)
...
""")
        st.write(f'ผู้พัฒนา Project : นางสาวณัฐณิชา ถนอมลาภ , นางสาวณัฐณิรชา ถนอมลาภ')
